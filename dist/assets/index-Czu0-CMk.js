...
void main() {
    ...
    `}renderPhotoPanel(e){let t=ou(this.scanGrid),n=eu[this.scanFace],r=this.scanGrid[this.scanFace],i=this.scanPhotos[this.scanFace],a=this.scanCameraActive?this.scanLiveColors:Array(9).fill(`X`),o=Math.round(this.scanQuality*100),s=this.scanQuality>0?`${o}%`:`-`;e.innerHTML=`
